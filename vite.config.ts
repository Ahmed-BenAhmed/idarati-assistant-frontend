...
export default defineConfig(({ mode }) => {
    ...
    return {
      ...
      define: {
        ...
        'process.env.REACT_APP_SUPABASE_PUBLISHABLE_DEFAULT_KEY': JSON.stringify(env.REACT_APP_SUPABASE_PUBLISHABLE_DEFAULT_KEY),
        ...
        'import.meta.env.VITE_SUPABASE_ANON_KEY': JSON.stringify(env.REACT_APP_SUPABASE_PUBLISHABLE_DEFAULT_KEY),
      },
      resolve: {
        alias: {
